...
# found in the LICENSE file.
{
  'targets': [
    ...
    },
    {
      ...
      'target_name': 'android_support_v7_appcompat_jar_no_res',
      'type' : 'none',
      'variables': {
        'jar_path': '<(android_sdk_root)/extras/android/support/v7/android-support-v7-appcompat/libs/android-support-v7-appcompat.jar',
      },
      'includes': ['../../build/java_prebuilt.gypi'],
    },
    {
      ...
      # revision 18 of the Android Support library. This library doesn't
      # contain the resources needed for the library to work.
      'target_name': 'android_support_v7_mediarouter_jar_no_res',
      'type' : 'none',
      'variables': {
        'jar_path': '<(android_sdk_root)/extras/android/support/v7/android-support-v7-mediarouter/libs/android-support-v7-mediarouter.jar',
      },
      'includes': ['../../build/java_prebuilt.gypi'],
    },
    {
      ...
      'dependencies': [
        'android_support_v7_appcompat_jar_no_res',
      ],
